...
string GBamRecord::getCIGAR()//yuting 
{
    ...
    int l=0;
    uint start_ = 0;
    int M=0,NM=0,I=0,D=0,S1=0,S2=0;
    ...
    string s1=to_string(M),s2 = to_string(NM),s3=to_string(I),
	   s4=to_string(D),s5=to_string(S1),s6=to_string(S2);
